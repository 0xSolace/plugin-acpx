...
import { getAcpService, labelFor, listSessionsWithin, shortId } from "../actions/common.js";
...
export const availableAgentsProvider: Provider = {
  ...
  get: async (runtime: IAgentRuntime, _message: Memory, _state: State) => {
    ...
    const [agents, sessions] = await Promise.all([
      service.checkAvailableAgents?.() ?? service.getAvailableAgents?.() ?? Promise.resolve([]),
